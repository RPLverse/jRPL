...
/**
 * Emits bytecode instructions for each element of the IR.
 *
 ...
 * <p>Responsibilities:
 * <ul>
 *   <li>Map each IR node type ({@link PushConst}, {@link Dup}, {@link BinOp}, ...)
 *       to a corresponding call on the {@link org.jrpl.runtime.ExecStack} object.</li>
 ...
 * <p>Design:
 * <ul>
 *   <li>All instructions operate on the first method parameter (the {@code ExecStack} instance).</li>
 *   <li>Helper methods reduce duplication (e.g. {@link #emitCall}).</li>
 *   <li>Conditional logic is implemented using ASM {@link Label} and jump opcodes.</li>
 * </ul>
 */
final class IrEmitter {
     ...
     *
     * <p>The runtime stack is expected to contain a boolean value
     * (1.0 for true, 0.0 for false) on top. This value is popped
     * and used as the branch condition.</p>
     */
