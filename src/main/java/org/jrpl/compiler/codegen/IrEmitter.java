 ...
 *       to a corresponding call on the {@link org.jrpl.runtime.S} stack object.</li>
 ...
 * <h2>Design:</h2>
 * <ul>
 *   <li>All instructions operate on the first method parameter (the {@code S} object).</li>
 *   <li>Helper methods reduce duplication (e.g. {@link #emitCall}).</li>
 *   <li>Conditional logic is implemented using ASM {@link Label}s and jump opcodes.</li>
 * </ul>
 */
final class IrEmitter {
    ...
    private static void emitPush(PushConst pc, MethodVisitor mv) {
        ...
        mv.visitMethodInsn(INVOKEVIRTUAL, "org/jrpl/runtime/S", "push", "(D)V", false);
    }
    ...
    private static void emitCall(MethodVisitor mv, String name, String desc) {
        mv.visitVarInsn(ALOAD, 0);
        mv.visitMethodInsn(INVOKEVIRTUAL, "org/jrpl/runtime/S", name, desc, false);
    }
    ...
    private static void emitIfElse(IfElse ie, MethodVisitor mv) {
        mv.visitVarInsn(ALOAD, 0);
        mv.visitMethodInsn(INVOKEVIRTUAL, "org/jrpl/runtime/S", "pop", "()D", false);
